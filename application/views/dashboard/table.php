          ...
          <nav class="mt-2">
            ...
            >
              ...
              <li class="nav-item menu-open">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="<?= base_url('dashboard/table') ?>" class="nav-link active">
                      <i class="nav-icon bi bi-circle"></i>
                      <p>Simple Tables</p>
                    </a>
                  </li>
  ...
  <div class="card shadow-sm">
    ...
    <div class="card-body p-0">
      <div class="table-responsive" style="max-height:500px; overflow:auto;">
        <table class="table table-striped table-hover align-middle text-center table-bordered-vertical" style="min-width:1000px;">
          ...
          <tbody>
            <?php if(!empty($users)): $i = $this->uri->segment(3) ? $this->uri->segment(3)+1 : 1; ?>
              <?php foreach($users as $u): ?>
                <tr style="white-space: nowrap;">
                  ...
                  <td>
                    <a href="<?= base_url('dashboard/view_user/'.$u->id); ?>" class="btn btn-sm btn-primary me-1">
                      <i class="bi bi-eye"></i>
                    </a>
                    <a href="<?= base_url('dashboard/edit_user/'.$u->id); ?>" class="btn btn-sm btn-info me-1">
                      <i class="bi bi-pencil-square"></i>
                    </a>
                    <a href="<?= base_url('dashboard/delete_user/'.$u->id); ?>" 
