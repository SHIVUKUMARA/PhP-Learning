        ...
        <div class="container d-flex justify-content-center align-items-center" style="min-height:70vh;">
            <div class="card shadow-lg border-0 rounded-lg text-center" style="width: 450px; background-color: #f8ea687a;">
                ...
                <div class="card-body mt-5 p-4">
                    ...
                    <?= form_open('dashboard/edit_user/'.$user->id) ?>

                    <!-- CSRF token will be added automatically by form_open() -->
                    ...
                    <div class="d-flex justify-content-center gap-3 mt-4">
                        ...
                        <a href="<?= site_url('dashboard/table'); ?>" class="btn btn-secondary btn-lg shadow-sm">
